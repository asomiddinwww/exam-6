  ...
  `}
      ...
      <div className="w-full font1">
        <div className="p-[12px] border-[#9e9d9d] flex justify-between border-b-1 w-full pl-3">
          ...
          <div class="flex items-center gap-4">
            <div>
              <button class="items-center justify-center gap-2  rounded-md text-sm font-medium transition-all outline-none  border border-[#e8e7e6] bg-background shadow-xs size-9 flex">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
        ...
        <div className="w-full p-4 pt-4">
          <div>
            <h1 className="text-[20.5px] font-[600]">
