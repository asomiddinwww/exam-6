  ...
  `}
      ...
      <div className="w-full">
        <div className="p-[12px] border-[#9e9d9d] flex justify-between  border-b-1 w-full pl-3">
          ...
          <div class="flex items-center gap-4">
            <div>
              <button class="items-center justify-center gap-2 border-[#e8e7e6] rounded-md text-sm font-medium transition-all outline-none  border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground size-9 flex">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
        ...
        <div className="p-5 pt-4">
          <div className="flex w-full justify-between">
            <h1 className="text-2xl font-[700]">To‘lovlar</h1>
            <button className=" pl-3 pr-3 flex items-center bg-black text-white gap-2 rounded-[8px]">
              <span className="text-2xl pb-1">+</span> To'lov qo'shish
            </button>
          </div>
          <div className="pt-5">
            <ul className="w-full flex items-center justify-between border p-2 border-[#e8e7e6] rounded-[8px] pr-40 font-[600] transition-all hover:bg-[#f4f3f3a1]">
              <li className="pr-8">Talaba</li>
              <li>Guruh</li>
              <li>Miqdor</li>
              <li>Oy</li>
              <li>Usul</li>
