      ...
      <div className="w-full font1">
        ...
        <div className="p-4 pt-4">
          <div className="w-full flex items-center justify-between">
            <h1 className="text-[21px] font-[600]">Guruhlar ro'yxati</h1>
            <div className="flex items-center gap-4">
              <button className=" pl-2.5 pr-2.5 pt-[4px] pb-[3.5px] text-[15px] flex items-center bg-black text-white gap-2 rounded-[8px]">
                <span className="text-[18px]">+</span> Guruh Qo'shish
              </button>
            </div>
          </div>
          <div className="pt-4 text-[15px]">
            <table className="w-full">
              <thead>
                <tr className="flex items-center justify-between border-b pr-5 pb-3 border-[#e8e7e6] pl-4">
